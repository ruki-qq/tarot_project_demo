...
from api.v1.models import Candidate, Employee
...
async def generate_random_employees(
    ...
    for _ in range(num_employees):
        ...
        if "Developer" in position or "Engineer" in position:
            department = choice(
                ["Engineering", "Web Development", "Mobile Development"]
            )
        ...
        bio_parts = [
            f"Professional {position} with {(date.today() - hire_date).days // 365} years of experience in {department}.",
